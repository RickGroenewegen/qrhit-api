      ...
      try {
        ...
        return reply.send({
          ...
          design: {
            ...
            boxFrontTitleType: php.boxFrontTitleType,
            boxFrontTitleText: php.boxFrontTitleText,
            boxFrontTitleFont: php.boxFrontTitleFont,
            boxFrontTitleFontSize: php.boxFrontTitleFontSize,
            boxFrontTitleColor: php.boxFrontTitleColor,
            boxFrontTitlePositionX: php.boxFrontTitlePositionX,
            boxFrontTitlePositionY: php.boxFrontTitlePositionY,
            boxFrontTitleStrokeWidth: php.boxFrontTitleStrokeWidth,
            boxFrontTitleStrokeColor: php.boxFrontTitleStrokeColor,
            boxFrontTitleShadowEnabled: php.boxFrontTitleShadowEnabled,
            boxFrontTitleShadowColor: php.boxFrontTitleShadowColor,
            boxFrontTitleShadowBlur: php.boxFrontTitleShadowBlur,
            boxFrontTitleShadowOffsetX: php.boxFrontTitleShadowOffsetX,
            boxFrontTitleShadowOffsetY: php.boxFrontTitleShadowOffsetY,
      ...
      try {
        ...
        await prisma.paymentHasPlaylist.update({
          ...
          data: {
            ...
            // Box front title
            boxFrontTitleType: boxDesign.boxFrontTitleType,
            boxFrontTitleText: boxDesign.boxFrontTitleText,
            boxFrontTitleFont: boxDesign.boxFrontTitleFont,
            boxFrontTitleFontSize: boxDesign.boxFrontTitleFontSize,
            boxFrontTitleColor: boxDesign.boxFrontTitleColor,
            boxFrontTitlePositionX: boxDesign.boxFrontTitlePositionX,
            boxFrontTitlePositionY: boxDesign.boxFrontTitlePositionY,
            boxFrontTitleStrokeWidth: boxDesign.boxFrontTitleStrokeWidth,
            boxFrontTitleStrokeColor: boxDesign.boxFrontTitleStrokeColor,
            boxFrontTitleShadowEnabled: boxDesign.boxFrontTitleShadowEnabled,
            boxFrontTitleShadowColor: boxDesign.boxFrontTitleShadowColor,
            boxFrontTitleShadowBlur: boxDesign.boxFrontTitleShadowBlur,
            boxFrontTitleShadowOffsetX: boxDesign.boxFrontTitleShadowOffsetX,
            boxFrontTitleShadowOffsetY: boxDesign.boxFrontTitleShadowOffsetY,
            // Box back design
