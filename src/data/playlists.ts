...
export async function getPlaylistsByPaymentId(
  ...
  let query = `
    SELECT
      ...
      payment_has_playlist.boxFrontTitleType,
      payment_has_playlist.boxFrontTitleText,
      payment_has_playlist.boxFrontTitleFont,
      payment_has_playlist.boxFrontTitleFontSize,
      payment_has_playlist.boxFrontTitleColor,
      payment_has_playlist.boxFrontTitlePositionX,
      payment_has_playlist.boxFrontTitlePositionY,
      payment_has_playlist.boxFrontTitleStrokeWidth,
      payment_has_playlist.boxFrontTitleStrokeColor,
      payment_has_playlist.boxFrontTitleShadowEnabled,
      payment_has_playlist.boxFrontTitleShadowColor,
      payment_has_playlist.boxFrontTitleShadowBlur,
      payment_has_playlist.boxFrontTitleShadowOffsetX,
      payment_has_playlist.boxFrontTitleShadowOffsetY,
