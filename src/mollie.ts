      ...
      select: {
        ...
        PaymentHasPlaylist: {
          select: {
            ...
            boxFrontEmoji: true,
            boxFrontTitleType: true,
            boxFrontTitleText: true,
            boxFrontTitleFont: true,
            boxFrontTitleFontSize: true,
            boxFrontTitleColor: true,
            boxFrontTitlePositionX: true,
            boxFrontTitlePositionY: true,
            boxFrontTitleStrokeWidth: true,
            boxFrontTitleStrokeColor: true,
            boxFrontTitleShadowEnabled: true,
            boxFrontTitleShadowColor: true,
            boxFrontTitleShadowBlur: true,
            boxFrontTitleShadowOffsetX: true,
            boxFrontTitleShadowOffsetY: true,
      ...
      const playlists = await Promise.all(
        params.cart.items.map(async (item: CartItem, index: number) => {
          ...
          return {
            ...
            // Box front title
            boxFrontTitleType: item.boxFrontTitleType || 'logo',
            boxFrontTitleText: item.boxFrontTitleText || '',
            boxFrontTitleFont: item.boxFrontTitleFont || 'Arial, sans-serif',
            boxFrontTitleFontSize: item.boxFrontTitleFontSize ?? 32,
            boxFrontTitleColor: item.boxFrontTitleColor || '#ffffff',
            boxFrontTitlePositionX: item.boxFrontTitlePositionX ?? 50,
            boxFrontTitlePositionY: item.boxFrontTitlePositionY ?? 50,
            boxFrontTitleStrokeWidth: item.boxFrontTitleStrokeWidth ?? 0,
            boxFrontTitleStrokeColor: item.boxFrontTitleStrokeColor || '#000000',
            boxFrontTitleShadowEnabled: item.boxFrontTitleShadowEnabled || false,
            boxFrontTitleShadowColor: item.boxFrontTitleShadowColor || '#000000',
            boxFrontTitleShadowBlur: item.boxFrontTitleShadowBlur ?? 4,
            boxFrontTitleShadowOffsetX: item.boxFrontTitleShadowOffsetX ?? 2,
            boxFrontTitleShadowOffsetY: item.boxFrontTitleShadowOffsetY ?? 2,
            // Box back design
