...
class PrintEnBindV2 {
  private static instance: PrintEnBindV2;
  ...
  public static getInstance(): PrintEnBindV2 {
    if (!PrintEnBindV2.instance) {
      PrintEnBindV2.instance = new PrintEnBindV2();
    }
